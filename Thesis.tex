...
In other words, higher-quality instincts will evolve with low numbers of evolutionary tasks in the environment,
and lower-quality instincts will evolve with higher numbers of evolutionary tasks in the environment.
...
For example, it could be the case that the quality of both evolved instincts and generalized learning are proportional to the number of tasks in the evolutionary environment,
