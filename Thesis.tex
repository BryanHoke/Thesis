...
The portion of the chromosome which encodes the network weights is isolated and evaluated on the evolutionary tasks by initializing a network, with the intention of determining the contribution the portion of the chromosome which encodes the initial weights to the fitness of the whole chromosome.

Chromosomes evolved using the non-nurturing condition performed better on this evaluation than chromosomes evolved using the nurturing condition, suggesting that the initial weights make a larger contribution to fitness in the non-nurturing case than in the nurturing case.
...
\begin{figure}[H]
	...
	\caption{Non-nurturing learning test on evolutionary tasks.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics{NurturingLearningTestPlot.pdf}
	\caption{Nurturing learning test on evolutionary tasks.}
\end{figure}
