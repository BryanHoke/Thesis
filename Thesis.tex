...
the nurturing condition (Pearson correlation, $\rho=-0.63,$ $p=2.4733*10^{-68}$)
and the non-nurturing condition (Pearson correlation, $\rho=-0.83,$ $p=6.4082*10^{-156}$).
...
the intra-learning test under both the nurturing condition (Pearson correlation, $\rho=0.62,$ $p=1.1287*10^{-64}$) 
and the non-nurturing condition (Pearson correlation, $\rho=0.43,$ $p=9.2470*10^{-28}$)
and the post-learning test under both the nurturing condition (Pearson correlation, $\rho=0.61,$ $p=1.7527*10^{-62}$)
and the non-nurturing condition (Pearson correlation, $\rho=0.42,$ $p=5.2515*10^{-27}$).
