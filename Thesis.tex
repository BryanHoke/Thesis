...
Alternately, it could be the case that both higher-quality instincts and higher-quality generalized learning evolve without than with,
...
and so they will be tested using randomized ANOVA,
which is a procedure for comparing performance curves \cite{Piater:1998aa}.
