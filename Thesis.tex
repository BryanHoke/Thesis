...
The quality of generalized learning evolved was found to be proportional to the number of tasks in the environment,
demonstrating that the original findings of \citet{Chalmers:1990aa} were robust to the addition of the possibility of evolving instincts.
The quality of instincts evolved was found to be inversely proportional to the number of tasks in the environment.
...
reconfirming the original findings of \citet{Chalmers:1990aa} and demonstrating that they were valid even under the non-nurturing condition.

%% Contributions
\section{Contributions}

This work provides concrete evidence that nurturing promotes the evolution of learning.
...
and \cite{Shah:2015hs},
who demonstrated that nurturing promotes the evolution of learning in changing environments.

This work also provides clarification of the role that instincts may play in the evolutionary process
alongside previous work by \citet{Niv:2002aa} and \citet{Shah:2015hs}.

Finally, this work provides a reconfirmation of \citet{Chalmers:1990aa}'s basic conclusions
and shows that they are robust enough to hold up under additional conditions (the non-nurturing condition and the possibility of evolving instincts).
