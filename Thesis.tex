...
The hypotheses of this work are detailed in chapter 2. Operational definitions for terms such as ``nurturing" and ``instincts" are given in chapter 3. The experimental procedure is detailed in chapter 4. The experimental results are given in chapter 5. The conclusion drawn from the experimental results is given in chapter 6. Finally, ideas for future work are described in chapter 7.
