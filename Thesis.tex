...
\citet{Werbos:1975aa} developed the backpropagation algorithm for training multi-layer networks.
...
The \emph{Neocognitron} \citep{Fukushima:1980aa} was both the first deep neural networks and the first convolutional neural network.
