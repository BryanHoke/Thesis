...
the nurturing condition (Pearson correlation, $r=-0.6324,$ $p=2.4733*10^{-68}$)
and the non-nurturing condition (Pearson correlation, $r=-0.8331,$ $p=6.4082*10^{-156}$).
...
the intra-learning test under both the nurturing condition (Pearson correlation, $r=0.6187,$ $p=1.1287*10^{-64}$) 
and the non-nurturing condition (Pearson correlation, $r=0.4253,$ $p=9.2470*10^{-28}$)
and the post-learning test under both the nurturing condition (Pearson correlation, $r=0.6102,$ $p=1.7527*10^{-62}$)
and the non-nurturing condition (Pearson correlation, $r=0.4197,$ $p=5.2515*10^{-27}$).
