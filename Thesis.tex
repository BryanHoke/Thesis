...
Artificial neural networks are a method of performing computation inspired by the biological neural networks found in nature.
They are implemented as networks of computational units, referred to as artificial neurons, which transform inputs and propagate information to each other through weighted connections.
...
When coupled with learning rules that update the values of weights, artificial neurons can learn discrete functions.
An example of such a learning rule is the well-known delta learning rule.
